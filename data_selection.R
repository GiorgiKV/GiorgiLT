...
league_data_select <- function(input, output, session, dat, main_char_str){
...
plot_data_select <- function(input, output, session, dat, main_char_str, plot_outcome){
  ...
  reactive({if(plot_outcome() == "qalys"){
